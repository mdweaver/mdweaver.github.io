...
- **targeting**?
    ...
    - can intra-ethnic violence be "ethnic"?
    - can selective targeting be ethnic? (must targeting be collective to be ethnic?)
    - does targeting need to be **intentionally** ethnic?
- **frequency**?
...
- "a pair of Hungarian youths were pushed from a train by Slovakian youths after a soccer match. ... one of the youths was seriously injured, and ... the incident occurred after the Hungarians had been singing Hungarian nationalist songs" (Brubaker and Laitin 2004)

>- Not coded as "ethnic", coded as "football" violence

- Estonian-language school in Russian-speaking region of Estonia was burned down. (Brubaker and Laitin 2004)

>- Coded as "mafia" violence

- Police violence against villagers in Narayanpur, UP in response to complaints about compensation for hit and run killing. (Brass 1997)

>- Coded as ethnic violence against Scheduled Castes

## Perception Matters

In addition to the **pattern of violence** (what was actually done), it matters **how** violence is *perceived*:

- Who is the audience for violence (intended vs actual; local vs national vs global)? 
...
>- Can you think of any examples where there has been disagreement over whether violence is "ethnic"?
