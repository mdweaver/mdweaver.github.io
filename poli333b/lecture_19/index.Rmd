...
- Immigration distinctive?
- Two examples
- Type of immigrant conflict (Dancygier)
...
1. **Strategic**: changes incentives (Tilly 2004) (winning coalitions, economic competition)
2. **Psychological**: changes the salience of ethnic categories (Hale), changes the set of status comparisons (SIT)
3. **Structural**: "encounter" of new groups; changing boundary practices of cultural differentiation, institutional separation, marking of difference
...
- in terms of **what are the causes**
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/WWGiRX_uEHs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<img src="./dancygier_5.png" width = 60%>
...
- wards with greater in-migration of West Indian and AFricans have lower rates of racist violence (against those groups)
