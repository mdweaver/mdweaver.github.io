...
1. Course Survey: 
  - Submit name/Qualtrics ID ASAP
  - Survey will be posted by the weekend (1 pt)
  - Extra credit assignment using survey results (2 pts)
2. Final Exam:
  - On Canvas: April 20-22 (1.5 hours)
  - Randomized questions
  - Example questions/exams available
...
| Conditioning | Hold confounders<br>constant | Only confounders <br> conditioned on | 1. Condition on all confounders <br> 2. Low measurement error | Low | High |
...
- the nature of the comparison holds constant **types of confounding variables**, not merely specific confounding variables.
...
- counties that had a Clinton rally **to themselves**, **before and after** the rally.
...
Which of these possible confounders are held constant in before-and-after comparison?
...
- does not matter if we can think of/measure confounders
...
Constant upward trend; no change when rallies occur
...
Trump tweets and anti-Muslim hate crimes **change together over time**: a before-and-after comparison

## Trump's Twitter and Hate Crimes

Does this evidence convince you that that Trump tweets **caused** a change in hate crimes? Why or why not?

>- Is there a better comparison we can make to find out if Trump Tweets caused hate crimes?
