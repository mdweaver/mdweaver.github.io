...
are **abstract** or **general** categories that we apply to **particular** cases using with a set of rules/criteria that determine membership in the category.

For concepts to be useful in scientific evidence... 
...
- relevant (maybe not the Kim Jung Un definition...)

## Concepts and Science:

### Insight:

Depending on the kinds of questions we are interested in, there are many **different definitions** for the same concepts. 
...
4. **Scientific concepts are "objective" in the sense they can be used even if we disagree with them**
  - "subjective" in sense that value judgements may make us prefer one definition of a word over another.
