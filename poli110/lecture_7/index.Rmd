...
- Assignment 1
    ...
    - use of Macleans articles is optional; just a way to come up with contemporary political issues
    - Don't quote a claim directly; paraphrase it to make the claim more clear.
    
- Group Activity:

    - This week, propose a possible solution to the problem you identified (a prescriptive claim of what we should do)
    - propose a causal claim  **that you could attempt to answer using a survey** and would help you decide whether to accept the propose solution.
...
#### (3) Concepts must be tied to prediction (not strictly necessary to evaluate claims)
...
Go to [menti.com](menti.com) and enter the code $8836 \ 3869$
...
From the perspective of scientifically evaluating descriptive claims:
...
- e.g., from the perspective of physics, the name "electron" is not relevant to how we define the properties of that particle.
