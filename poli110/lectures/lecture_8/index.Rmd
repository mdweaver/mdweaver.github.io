...
## Choosing the right variable: {.build}
...
## Variables and Causal Claims: {.build}

### Causal Claim:

Mass mobilization for war expands suffrage.

### Cause is "mass mobilization for war"

### Outcome is "expanded suffrage" 
...
**Variable**: fraction of  population in military service during wartime

**Variable**: fraction of  population eligible to vote
...
A **higher proportion of the population in wartime military service** causes an increase in the **fraction of the population eligible to vote**. 

**Independent Variable**: fraction of  population in military service during wartime

**Dependent Variable**: fraction of  population eligible to vote
...
- often denoted as "IV" or "X" or "right-hand"

### Dependent variable:

The variable capturing the purported **outcome** in a causal claim.

- often denoted as "DV" or "Y" or "left-hand"
...
Ethnic diversity  causes poorer economic growth.

**Independent Variable**: **level** of ethnic diversity
...
A greater **level of ethnic diversity** causes a lower **rate of economic growth**.
...
A set of **general** causal claims about cause/effect of some phenomenon. It must include:

- An independent variable (IV)
- A dependent variable (DV)
- What is the effect of IV on DV
- Causal logic through which effect happens
  
Causal theories turn causal claims into something **testable**.

## A Causal Theory:

1. General causal claim: "A lower **level of material resources** increases the **likelihood of civil war** in a country."
2. IV and DV: 
    - IV: **level of material resources**
    - DV: **likelihood of civil war**
3. Causal Logic:
    - Fewer material resources $\xrightarrow{}$
    - Poor job prospects for young men $\xrightarrow{}$
    - Opportunity cost of joining armed group is lower $\xrightarrow{}$
    - Young men more likely to join armed groups $\xrightarrow{}$
    - Armed groups have easy recruitment $\xrightarrow{}$
    - Easier to start/sustain a war against the state
