...
<!-- Similar units at same time -->
<!--   - same geographic area, etc experience shared trends over time by virtue of being similar -->

<!-- Same unit across time -->
<!--   - Same units across time: eliminates unchanging variables -->

<!-- ## Difference in Difference: -->

<!-- Table: -->
<!-- First Difference (within unit) -->

<!-- Second Difference (between units) -->
