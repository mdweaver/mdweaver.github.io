...
1. Location:
    - Water supply is determined by where you are. But "miasma" is a gas and also is located in an area.
    - Miasmas might cause cholera
2. Timing:
    - Water supply contamination might occur at one specific time, but so might miasmas
    - Miasmas might appear at some point in time and cause cholera
