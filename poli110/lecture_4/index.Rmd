...
practice recognizing types of claims
...
- example of logic of inference... we want to know whether claims are right or wrong to make a decision: election fraud paper
- does this count as scientific evidence?


this is logic of confirmation

difficulty is with logic of confirmation

veritasium example:
- slide with the treatment charts
- video clip
...
1. there is an **objective reality** (*noumena*) outside of our perceptions => we need to be able to systematically engage with this reality
2. we all *experience* the ***same*** objective reality with others => we need to be able to replicate; we need information from others to challenge our misperception
3. this reality operates under consistent rules
4. we can only learn about this objective reality **through our sense experiences** (*phenomena*) as filtered through our minds. => because know our experiences can be misleading, tendency toward confirmation bias, need to apply tools that can show us to be wrong.
