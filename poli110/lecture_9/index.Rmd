...
**Measure**: As of this morning BC CDC reports $23,739$ active cases. Those are the number of people who have tested positive, excluding those who died, [recovered](http://www.bccdc.ca/resource-gallery/Documents/Guidelines%20and%20Forms/Guidelines%20and%20Manuals/Epid/CD%20Manual/Chapter%201%20-%20CDC/2019-nCoV-Interim_Guidelines.pdf), or could not be found for followup. 

That implies $468$ active cases per 100k.

>- Is this observed value **too high**? **too low**? **correct**?
...
**Variable**: average hours/day of screentime 

**Measure**: time-use survey of where individuals record their screen use over the course of **one day**
...
ggplot(plot_data, aes(value, fill = Measure)) + 
  ...
  labs(title = 'Different measures of variable X') + xlab("Observed Value X - True Value X") + ylab("Frequency") + 
  theme_bw() +
  geom_vline(xintercept = 0, colour = 'red')
```

https://www.menti.com/jn7asespp7
...
We are back in person: we might want to know what the possible risks are:

**$1.$ Fraction of students registered to live in campus housing who report testing positive using PCR or antigen tests to VCH?**

- As a measure of "rate of on-campus transmission" does this suffer from systematic or random measurement error (or both)?

**$2.$ Fraction of students who file concessions with Arts Advising over coursework due to COVID symptoms?**

- As a measure of the "fraction of Arts students whose ability to do coursework is affected by COVID" does this suffer from systematic or random measurement error (or both)?
