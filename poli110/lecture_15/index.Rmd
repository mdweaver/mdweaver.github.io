...
We need to see **variation** in exposure to the cause
...
2. Making assumptions that let us treat **factual** (observed) potential outcomes from one case as equivalent to **counterfactual** (unobserved) potential outcomes of another case.
...
we can correctly describe the chance processes that generate this correlation


---

<img src="https://i.imgur.com/k4ceCBs.jpeg" width=100%>
