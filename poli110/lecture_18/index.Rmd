...
Negative correlation does not guarantee causation
...
- We can't know the causal effect for individual cases, but can get the **average effect** across all cases
...
means we aren't *adding* confounding in the design of the experiment
...
These **design** features of the experiment ensure that **only difference** between "assigned to treament" and "assigned to control" is the vaccine.
...
[https://www.menti.com/bz4gsu58z2](https://www.menti.com/bz4gsu58z2) or [menti.com](menti.com) $3291 \ 8704$
