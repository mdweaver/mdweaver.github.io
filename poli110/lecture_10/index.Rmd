...
Why do you think that the polling in the US 2020 Presidential Election was so wrong?
...
- 52% of Americans want inteded to vote for Biden, 42% for Trump, with some **uncertainty** due to sampling
...
$2$. **random sampling error**: with random sampling, by chance, we get samples where the average is **too high** or **too low** compared to the population, but these errors would cancel out. (captured by **margin of error**)

## Example

<img src="./538_2.png" width=100%>

With **random** samples, sometimes we get a sample with too many Biden supporters, sometimes we get a sample with too many Trump supporters. This uncertainty knowable mathematically.
