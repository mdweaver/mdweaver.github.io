...
- the **assumptions** required for the evidence to be valid "proof" (sometimes called the "warrant")


colloquially: we often collapse these as just "evidence"
...
- Cherry picking excludes data that does not support argument
...
### **Which of these do you think is the most important part of scientific evidence?**
...
- Control conditions address this concern
