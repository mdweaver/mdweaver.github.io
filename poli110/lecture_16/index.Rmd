...
plot(x,y, main = "5 cases\nX and Y chosen randomly")
text(mean(x), mean(y), labels = paste0("Correlation: ", round(c, 2)), adj = 0.5)
text(mean(x) + sd(x),mean(y) + sd(y), labels = paste0("Tries: ", counter), adj = 0.5)
```
...
text(mean(x), mean(y), labels = paste0("Correlation: ", round(c, 2)), adj = 0.5)
text(mean(x) + sd(x),mean(y) + 0.5*sd(y), labels = paste0("Tries: ", counter), adj = 0.5)
```
...
<img src='./mueller_2.png' width=80%>
...
<img src='./mueller_4.png' width=60%>
