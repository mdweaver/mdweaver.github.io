...
$\displaylines{Y_{it} = \beta_0 + \beta_1 \mathrm{Treated}_{i} + \beta_2 \text{Post}_{t} +\\\beta_3 \text{Treated}_{i}\cdot \text{Post}_{t}}$
...
- Is this different from effect of INC win when ENP at (lower/higher value)?
...
- But it could also be that there are OTHER mechanisms: slavery $\to$ greater contemporary African American population $\to$ contemporary perceived "racial threat" $\to$ contemporary attitudes
...
Basically, if there **other ways** treatment can affect outcome, and those other paths possibly affect mediator $M$, there will be bias. This is almost always possible.
...
Bullock and Green: simple rules

<img src="bullock_green.png">
