...
In regression context, [Abadie et al (2020)](https://onlinelibrary.wiley.com/doi/abs/10.3982/ECTA12675) describe three possible types of inferences.
...
[More details](https://www.econstor.eu/bitstream/10419/198589/1/WP2019_13.pdf)
...
[more bootstrap details/practice](#bootstrap)
...
- Or use the `tidy` function in the `broom` package, [make your own plot](https://broom.tidymodels.org/reference/tidy.lm.html).
