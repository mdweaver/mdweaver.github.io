...
$$E[\widehat{ACE}] = E[Y_i(1) | D_i = 1 ] - E[Y_i(0) | D_i = 0]$$
$$
\begin{align*}
E[\widehat{ACE}] =& \overbrace{E[Y_i(1)] - E[Y_i(0)]}^{\text{ACE}} \ + \\
& \overbrace{E[Y_i(0) | D_i = 1 ] - E[Y_i(0) | D_i = 0]}^{\text{Selection Bias}} \ +\\
& \overbrace{(1-\pi_1)(E[\tau_i | D_i = 1 ] - E[\tau_i | D_i = 0])}^{\text{Heterogenetiy Bias}}
\end{align*}
$$
...
**selection bias**: *baseline* differences in $Y(0)$ between "treated" and "untreated" units ($D=1$, $D=0$). Treated group **already** different in absence of treatment.
