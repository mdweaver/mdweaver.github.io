...
stargazer(lm_iowa,
          type = 'html',
          keep.stat = 'n',
          covariate.labels = c("Enlist Rate", "Combat Days", "Enlist X Combat"),
          dep.var.labels = 'Suffrage Difference')
...
stargazer(lm_iowa_c,
          type = 'html',
          keep.stat = 'n',
          covariate.labels = c("Enlist Rate (0)", "Combat Days (0)", "Enlist X  Combat"),
          dep.var.labels = 'Suffrage Difference')
```
...
- For any **continuous** interactions, estimation is tricky and we must calculate marginal effects. 
    ...
    - Get tests of linearity, SEs, plots