...
**Why focus on prediction? Why focus on the mean?**

- Our causal estimands are mostly **average** effects
- Estimation requires us 'plug-in' or predict unobserved potential outcomes. 

**Understanding how the mean, regression does this helps us understand more going forward**:

- how does regression "control for a variable"? What does that mean?
...
- vectors can be multiplied by a number to extend/shorten their length (each element multiplied by same number)
