...
and $\mathbf{X}$, an $n \times p$ dimensional matrix ($p$ columns, $n$ observations)
...
Solve for $a$ and $b$ using $\frac{Cov(x,y)}{Var(x)}$
...
1. Create the $X$ matrix to estimate $Y_i = b_0 + b_1 x_i + b_2 z_i$
