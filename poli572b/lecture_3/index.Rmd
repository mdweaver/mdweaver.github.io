...
Compare all **treated** (screened) to all **untreated** (were not screened in T and C)
...
>- We don't need to directly observe compliers!
...
- Allows us to assume that unit causal effects for **compliers** are the same in assign-to-treat and assign-to-control:
    - $Y_c(Z=0,D=1) - Y_c(Z=0,D=0) = Y_c(Z =1, D=1) - Y_c(Z=1, D=0)$
