...
$$\widehat{\tau_i} = \underbrace{[Y_{i,t=1}(1) | D_i = 1]}_{\text{Liverpool post-1989, boycott}} - \overbrace{[Y_{i,t=0}(0)|D_i = 1]}^{\text{Liverpool } \textbf{pre-1989}\text{, no boycott}}$$
...
$$\overbrace{[Y_{i,t=0}(0)|D_i = 1]}^{\text{Liverpool } \textbf{pre-1989}\text{, no boycott}} = \color{red}{\overbrace{[Y_{i,t=1}(0)|D_i = 1]}^{\text{Liverpool post-1989, no boycott}}}$$ 
...
We don't know: $\color{red}{\overbrace{[Y_{i,t=1}(0)|D_i = 1]}^{\text{Liverpool post-1989, no boycott}}} - \overbrace{[Y_{i,t=0}(0)|D_i = 1]}^{\text{Liverpool } \textbf{pre-1989}\text{, no boycott}}$

We **do know**: $\underbrace{[Y_{i,t=1}(0) | D_i = 0]}_{\text{UK post-1989, no boycott}} - \underbrace{[Y_{i,t=0}(0)|D_i = 0]}_{\text{UK } \textbf{pre-1989}\text{, no boycott}}$
...
```{r normp, echo=FALSE, message=F, warning=F}
library(tidyverse)
