...
2. What is the interpretation of $\hat{y}$ when $b_1 = 0$?
4. What is the interpretation of $\hat{y}$ when $b_1 = 1$?
...
2. What is the interpretation of $\hat{y}$ when $b_1 = 0$?
4. What is the interpretation of $\hat{y}$ when $b_1 = 2$?
3. What does the $b_0$ tell us? 
3. What does the $b_1$ tell us? 
...
1. What does the design matrix $X$ in this regression look like?
2. What is the interpretation of $\hat{y}$ when $b_1 = 0$ and $b_2 = 1$?
4. What is the interpretation of $\hat{y}$ when $b_1 = 1$ and $b_2 = 0$?
...
1. What does the design matrix $X$ in this regression look like?
2. What is the interpretation of $\hat{y}$ when $b_0 = 0$ and $b_1 = 1$?
4. What is the interpretation of $\hat{y}$ when $b_0 = 1$ and $b_1 = 0$?
2. What does the $b_0$ tell us?
3. What does the $b_1$ tell us?
