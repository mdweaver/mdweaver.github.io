...
Do you find these statistical tests persuasive (above causality)?
...
#### Statistical evidence for causality in the **real world** combines observed data with a **mathematical model** of the world

>- mathematical model of how the data are generated
>- always involve assumptions
...
### What does it mean to say that contact **causes** a reduction in prejudice?
...
### A way to formalize a mathematical model of causality

## Potential Outcomes

Imagine you were a participant in an experiment similar to the Broockman and Kalla paper...

Write down what you imagine your score would be on a series of questions about group stereotypes (high (3), medium (2) low (1))

>- If you were in the **no contact** group

>- If you were in the **contact** group

## Potential Outcomes

In an experiment with two conditions: each subject, prior to intervention has two possible states that it could take. 

If $Y_i$ is the level of prejudice for person $i$; $Z$ is the experimental condition: $1$ indicates contact, $0$ no contact, then we have two **potential outcomes**

1. Level of prejudice with **no contact** is $Y_i(0)$
2. Level of prejudice **with contact** is $Y_i(1)$
...
### What happen when we've fallen from Mount Olympus, and we actually have to run our experiment?
...
The potential outcomes model (or Neyman Causal Model) points toward a statistical solution:
