...
If $Y_i$ is the willingness to have lunch of person $i$; $Z_i$ is the experimental condition: $1$ indicates downranking, $0$ no change, then we have two **potential outcomes**
